...
switch (@$_REQUEST['acao']) {
    case 'enviar':
       ...
       $cep_ocorrencia = $_POST ['cep_ocorrencia'];
        ...
        VALUES ('luz', '{$comentario}', '{$ende_ocorrencia}','{$compl_ocorrencia}','{$cid_ocorrencia}','{$bairro_ocorrencia}','{$cep_ocorrencia}')";
...
<body>
  ...
  <form class="row g-3" action="?page=enviar2" method="POST">
    <div class="row">
      <div class="col-md-6">
      <input type="hidden" name="acao" value="enviar2">
      <input type="hidden" name="tipo_ocorrencia" value="luz">
